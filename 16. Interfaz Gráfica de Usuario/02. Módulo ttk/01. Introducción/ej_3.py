...
class Aplicacion:
    def __init__(self):
        ...
        self.label = ttk.Label(self.ventana, text="Selecciona una opción:")
        self.label.grid(row=0, column=2, padx=10, pady=10)

        self.seleccion = tk.IntVar()
        self.seleccion.set(2)

        self.radiobutton_varon = ttk.Radiobutton(self.ventana, text="Varón", variable=self.seleccion, value=1)
        self.radiobutton_varon.grid(row=0, column=0, padx=10, pady=10)

        self.radiobutton_mujer = ttk.Radiobutton(self.ventana, text="Mujer", variable=self.seleccion, value=2)
